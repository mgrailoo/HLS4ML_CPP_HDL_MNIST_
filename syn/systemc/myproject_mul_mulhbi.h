...
// ==============================================================
#ifndef __myproject_mul_mulhbi__HH__
#define __myproject_mul_mulhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_mul_mulhbi) {
    ...
    SC_CTOR(myproject_mul_mulhbi):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
